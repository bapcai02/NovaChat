            ...
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-xs text-green-600">
                  +{reportData?.newUsers} new this period
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-xs text-gray-500">
                  Average session: {reportData?.averageSessionTime}min
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-semibold">
                  {Math.round((reportData?.totalMessages || 0) / 7)}
                </span>
              </div>
              <div className="flex justify-between">
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-semibold">
                  {reportData?.averageSessionTime} min
                </span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-600">Total Bookmarks</span>
                <span className="font-semibold">
                  {reportData?.totalBookmarks.toLocaleString()}
                </span>
              </div>
            </div>
          </div>
