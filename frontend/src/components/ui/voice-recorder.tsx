      ...
      <div className="text-center">
        {isRecording && (
          <div className="flex items-center justify-center space-x-2 mb-2">
            ...
            <span className="text-sm text-[hsl(var(--chat-text-muted))]">
              Recording...
            </span>
          </div>
        )}
      ...
      <div className="h-16 bg-[hsl(var(--chat-message-bg))] rounded-lg p-2 relative overflow-hidden">
        {waveformData.length > 0 ? (
          <svg
            ...
            viewBox={`0 0 ${Math.max(waveformData.length * 10, 200)} 60`}
          >
      ...
      <div className="flex items-center justify-center space-x-4">
        {!audioBlob ? (
          ...
          <>
            ...
            <Button
              onClick={handleSend}
              className="bg-[hsl(var(--chat-accent))] hover:bg-[hsl(var(--chat-accent-hover))] text-white px-6"
            >
              <svg
                className="w-4 h-4 mr-2"
                fill="none"
