        ...
        <div className="p-4 border-b border-[hsl(var(--chat-border))] bg-[hsl(var(--chat-message-bg))]">
          <div className="flex items-start space-x-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-sm text-[hsl(var(--chat-text))] line-clamp-2">
                {message.content}
              </p>
            </div>
          </div>
            ...
            <div className="p-4 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="p-4 bg-[hsl(var(--chat-message-bg))] rounded-lg">
                  <div className="text-2xl font-bold text-[hsl(var(--chat-accent))]">
                    {getReadPercentage()}%
                  </div>
                  ...
                  <div className="flex items-center justify-between text-xs">
                    ...
                    <div className="flex-1 mx-2 h-2 bg-[hsl(var(--chat-border))] rounded-full overflow-hidden">
                      <div
                        ...
                        style={{
                          width: `${(getTotalReactions() / 20) * 100}%`,
                        }}
                      />
                    </div>
                  ...
                  <div className="flex items-center justify-between text-xs">
                    ...
                    <div className="flex-1 mx-2 h-2 bg-[hsl(var(--chat-border))] rounded-full overflow-hidden">
                      <div
                        ...
                        style={{
                          width: `${(message.replies.length / 10) * 100}%`,
                        }}
                      />
                    </div>
                ...
                >
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-sm text-[hsl(var(--chat-text))]">
                        {reply.content}
                      </p>
                    </div>
                  </div>
