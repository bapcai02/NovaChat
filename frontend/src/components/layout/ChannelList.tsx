  ...
  return (
    <div className="p-3">
          ...
          {channels.map((channel) => (
            <div
              ...
              className={`flex items-center px-2 py-1 rounded cursor-pointer group ${
                channel.name === 'general' ? 'bg-gray-700 text-gray-800' : 'text-gray-300 hover:bg-gray-700 hover:text-gray-800'
              }`}
            >
              ...
              {channel.unread > 0 && (
                <span className="bg-red-500 text-gray-800 text-xs px-1.5 py-0.5 rounded-full min-w-[20px] text-center">
                  {channel.unread}
                </span>
              )}
              <button className="opacity-0 group-hover:opacity-100 ml-1 text-gray-400 hover:text-gray-800">
      ...
      <div className="mb-4">
        ...
        <div className="space-y-1">
          <div className="flex items-center px-2 py-1 rounded cursor-pointer text-gray-300 hover:bg-gray-700 hover:text-gray-800 group">
            ...
            <span className="bg-red-500 text-gray-800 text-xs px-1.5 py-0.5 rounded-full">2</span>
          </div>
